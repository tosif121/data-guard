    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm border-l pl-4 border-neutral-200 dark:border-white/10">
            <RefreshCcw
              className={`h-4 w-4 text-neutral-400 ${!isPaused ? 'animate-spin' : ''}`}
        ...
        <div className="flex items-center gap-4">
          {isConnected && (
            <button
              ...
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-red-500 text-white shadow hover:bg-red-500/90 h-9 px-4 py-2"
            >
